...
function selectableForceDirectedGraph(file) {
  ...
  .on("brushstart", function(d) {
    ...
    .on("brush", function() {
      ...
      var graph = JSON.parse(JSON.parse(file));
      ...
      //https://stackoverflow.com/questions/30275337/d3js-why-are-my-fixed-nodes-moving
      ...
      // This lines make the nodes draggeables
